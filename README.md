...
* **Data Science & ML:** `Pandas`, `Scikit-learn`, `Keras`, `TensorFlow`, `NetworkX`
* **BI & Data Viz:** `PowerBI`, `Matplotlib`, `Excel`
...
* Wrote advanced `SQL` queries to simulate real-world business features:
    ...
    * **"Top Charts"**: Artist analytics segmented by followers.
    * **"Fraud Detection"**: Identified high-risk accounts to estimate revenue loss.
* **Tech Stack:** `SQL`, `Database Design (ERD)`
...
* **MSc in Biostatistics and Data Science**
